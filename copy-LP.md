# Copy Actuel de la Landing Page (Attention Architect)

## Hero Section
- **Surtitre :** POUR LES INFOPRENEURS QUI VEULENT PASSER LE CAP DES 100K€/MOIS
- **Titre principal :** Arrêtez de *brûler votre cash sur du trafic froid* à cause d'un tunnel VSL fracturé
- **Sous-titre / Paragraphe :** Votre coût par acquisition explose, vos marges se réduisent, et vos prospects sont mal qualifiés ? C'est le signe que votre tunnel VSL doit être réparé pour colmater les fuites et enfin scaler.
- **CTA (Bandeau défilant) :** Découvrir comment réparer votre tunnel VSL ↓

## Problem Section
- **Surtitre :** LE DIAGNOSTIC
- **Titre principal :** Le manque de cohérence de votre tunnel *détruit votre CPA*
- **Paragraphe :** Votre offre convertissait bien sur votre audience chaude. Mais face à des inconnus, c'est l'hécatombe. La pub vend une promesse, le titre de la landing page parle d'autre chose, et la VSL perd le prospect en 30 secondes. Ce manque de continuité psychologique sème le doute chez l'acheteur et fait exploser votre CPA.
- **Statistiques :**
  - **Le mensonge de l'algorithme :** Vous vous plaignez des "coûts qui montent". La réalité, c'est que votre page ne retient pas l'attention pour laquelle vous payez une fortune.
  - **L'hémorragie des 30 secondes :** 73% de vos prospects froids quittent votre vidéo avant même d'avoir entendu l'offre. S'ils ne regardent pas, votre ROI est de zéro.
  - **Piégé dans votre business  :** Vous passez vos nuits à "bricoler" vos pages au lieu de diriger votre entreprise.
- **Citation :** « On ne scale pas un business en changeant le titre d'une page. On scale en construisant un écosystème narratif indestructible. »

## Solution Section
- **Surtitre :** L'ARCHITECTURE DE CONVERSION
- **Titre principal :** Un écosystème aligné de *la première seconde de pub jusqu'à l'achat*
- **Étapes :**
  - **01. Les ads :** On ne cherche pas à faire des "vues", on cherche à qualifier l'audience. Je rédige des angles publicitaires chirurgicaux pour abaisser votre CPL et préparer le terrain psychologique.
  - **02. La mise en tension narrative :** Une landing page optimisée qui ne laisse aucune place à l'hésitation. L'objectif : que votre prospect se jette sur votre VSL pour obtenir ce qu'il désire.
  - **03. Le cœur du réacteur :** Une VSL haute performance qui accroche l'attention et désamorce le scepticisme en temps réel. Quitter la vidéo devient une perte immense pour le spectateur.
  - **04. La relance post-VSL :** Une séquence d'emails de vente chirurgicale pour rattraper les indécis dans les jours suivants et maximiser votre ROAS sans aucun effort de votre part.

## Offer Section
- **Surtitre :** LE MODÈLE PARTENAIRE
- **Titre principal :** Fini le tunnel fracturé, *voici l'écosystème complet*
- **Introduction :** J'implémente un système de conversion complet basé sur les frameworks utilisés dans les lancements des challenges 5 jours sur lesquels j'ai travaillé.
...
- **Les bonus offerts :**
  ...
  - **Bonus 3 : Le renouvellement mensuel des ads.** Tant que notre partenariat court, je fournis 3 nouveaux scripts d'ads chaque mois pour combattre la fatigue publicitaire sans frais supplémentaires.

## Guarantee Section
- **Surtitre :** GARANTIE TRANSFERT DE RISQUE
- **Titre principal :** Si je ne casse pas votre plafond de verre, *je travaille gratuitement*
...
- **Q : Combien de temps prend le déploiement de l'écosystème ?**
  - R : Comptez 1 mois entre notre appel stratégique de lancement et la livraison clé-en-main de tous les actifs (ads, LP, VSL, emails et bonus).
- **Q : Que se passe-t-il si les publicités s'épuisent ?**
  - R : C'est prévu dans le deal : tant que nous sommes partenaires, je vous fournis 3 nouveaux scripts d'ads chaque mois pour relancer votre acquisition sans aucuns frais supplémentaires.
